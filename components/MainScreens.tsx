  ...
  return (
    <div className="p-6 pb-[140px]">
      ...
      <GlassCard className="p-5 flex items-start gap-4">
        <div className="w-10 h-10 rounded-full bg-white/[0.08] border border-white/10 flex shrink-0 items-center justify-center text-lg shadow-sm">✺</div>
        <div>
  ...
  return (
    <div className="p-6 pb-[140px]">
      ...
      {hasRoutine ? (
         ...
         <GlassCard className="p-6 text-center py-10">
...
export function ScanView() {
  ...
  return (
    <div className="p-6 pb-[140px]">
      ...
      <div className="space-y-4">
         {cards.map((c, i) => (
           <GlassCard key={i} className="p-5 flex flex-col justify-end min-h-[140px]">
...
export function ProfileView({ onClear }: { onClear: () => void }) {
  ...
  return (
    <div className="p-6 pb-[140px]">
      ...
      <GlassCard className="flex items-center gap-4 p-5 mb-6">
      ...
      <div className="mb-6">
         ...
         <div className="flex bg-white/[0.06] border border-white/10 p-1 rounded-full backdrop-blur-xl">
            <button 
